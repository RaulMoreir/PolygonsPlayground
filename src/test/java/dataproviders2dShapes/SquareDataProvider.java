...
public class SquareDataProvider {
    ...
    public static Object[][] validCalculationSquareData() {
        return new Object[][] {
                {3, 9d},
                {Integer.MAX_VALUE, 4611686014132420608.0000},
                {6.5, 42.25},
                {22, 484},
                {23, 529}};
    }
    ...
    public static Object[][] invalidCalculationSquareData() {
        return new Object[][] {
                {-2, "Please input valid values to the Square sides"},
                {-2.5, "Please input valid values to the Square sides"},
                {0, "Please input valid values to the Square sides"}};
    }
